...
void PhysicsApplication::CreateScene()
{
	...
	m_physicsObjects.push_back(new Box(glm::vec2(-3, 5), 2.0f, 1.0f, glm::vec2(0), 2.0f, 0));
	m_physicsObjects.push_back(new Circle(glm::vec2(0), 1.0f, glm::vec2(1, 10), 1.0f, 0.1f));
	m_physicsObjects.push_back(new Circle(glm::vec2(2), 1.0f, glm::vec2(1, 10), 1.0f, 0.1f));
	m_physicsObjects.push_back(new Circle(glm::vec2(-1), 0.5f, glm::vec2(-1, 0), 0.5f, 0.1f));
